...
export const ui = {
  ...
  es: {
    ...
    "home.section.tools": "Herramientas Activas",
    "home.section.tools.viewAll": "Ir al taller →",
    ...
    "ops.guide.tracking": "EN SEGUIMIENTO",
  ...
  en: {
    ...
    "home.section.tools": "Active Tools",
    "home.section.tools.viewAll": "Go to workshop →",
