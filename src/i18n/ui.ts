...
export const ui = {
  ...
  en: {
    ...
    "home.module.activos.title": "Assets",
    ...
    "ops.banner.text": "Note: The detailed content of these operational guides (including Polymarket and Soneium) is currently available only in Spanish. We are actively working on the English versions.",
    ...
    "blog.banner.text": "Note: Detailed research articles are currently available only in Spanish. We are actively working on the English translations.",
