...
export const routeMap: Record<string, Record<Lang, string>> = {
  ...
  "/activos": { es: "/activos", en: "/en/assets" },
  "/activos/bitcoin": { es: "/activos/bitcoin", en: "/en/assets/bitcoin" },
  "/activos/ethereum": { es: "/activos/ethereum", en: "/en/assets/ethereum" },
  "/activos/sunflowerland": {
    es: "/activos/sunflowerland",
    en: "/en/assets/sunflowerland",
  },
