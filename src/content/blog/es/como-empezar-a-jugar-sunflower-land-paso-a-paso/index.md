---
layout: post
title: "Cómo empezar a jugar Sunflower Land paso a paso"
description: "Guía completa para empezar en Sunflower Land: desde la creación de tu cuenta, reclamar recompensas y aprender las mecánicas básicas de este divertido juego Web3."
category: "Gaming"
date: 2026-08-15
author: "0x Leñador"
...
Si quieres adentrarte en este mundo, aquí te explico cómo empezar.

## Paso 1: Crear tu cuenta

Primero, dirígete al sitio web oficial y crea una cuenta nueva usando este enlace: [sunflower-land.com](https://sunflower-land.com/play/?ref=Oxlenador).

![Pantalla principal del juego](./image1.png)

A continuación, deberás elegir cómo iniciar sesión. Te recomiendo utilizar una wallet que soporte la red de Base (Rabby Wallet es una excelente opción). Sin embargo, si no estás familiarizado con las wallets o prefieres algo más sencillo, puedes iniciar sesión directamente con tu cuenta de Google.

![Opciones de inicio de sesión](./image2.png)
...
![Confirmación de creación de granja](./image3.png)
...
![Ingresar código de referido](./image4.png)

![Paquete de bienvenida por referido](./image5.png)

Finalmente, elige el diseño inicial de tu Bumpkin (tu avatar) y haz clic en **Start**.

![Selección del Bumpkin](./image6.png)
...
> [!TIP]
> **Úsalos sabiamente.** Hay muchísimas estrategias, pero mi consejo para empezar es que vendas los *Love Charms* a cambio de FLOWER en la "Isla del Amor" (disponible cada 7 horas en la plaza principal). 
> Guarda tus **Gemas** exclusivamente para resetear el mercado de semillas y herramientas, ya que no hay otra forma de hacerlo y te harán mucha falta. En cuanto al **Tótem**, consérvalo para más adelante, cuando tu granja sea más grande o haya algún evento especial de producción.
...
![Mecánicas de cultivo y recolección](./image9.png)
