            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <a href="https://x.com/0xlenador" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-slate-500 hover:text-white text-sm transition group">
                        <span class="p-1 bg-slate-900 rounded group-hover:bg-emerald-500/20 transition"><svg class="w-3 h-3" fill="currentColor" viewBox="0 0 24 24"><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932 6.064-6.932zm-1.292 19.49h2.039L6.486 3.24H4.298l13.311 17.403z"/></svg></span> X (Twitter)
                    </a>
                    <a href="https://discord.gg/6QaVvzrn" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-slate-500 hover:text-white text-sm transition group w-fit">
