        ...
        <div class="max-w-6xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <a href="./index.html"
                        class="text-slate-500 hover:text-emerald-400 text-sm transition w-fit">Inicio</a>
                    <a href="./faucets.html"
                        class="text-slate-500 hover:text-emerald-400 text-sm transition w-fit">Faucets</a>
                    <a href="https://0xlenador.blogspot.com" target="_blank"
                        class="text-slate-500 hover:text-emerald-400 text-sm transition w-fit">Blog Estratégico</a>
                </div>
                <div class="flex flex-col gap-3">
                    <h4 class="text-white font-bold text-xs uppercase tracking-widest mb-2">Comunidad</h4>
                    <a href="https://www.youtube.com/@0xlenadorgamefi" target="_blank" rel="noopener"
                        class="flex items-center gap-2 text-slate-500 hover:text-white text-sm transition group">
                        <span class="p-1 bg-slate-900 rounded group-hover:bg-emerald-500/20 transition"><svg
                    ...
                    <a href="https://t.me/zero0xlenador" target="_blank" rel="noopener"
                        class="flex items-center gap-2 text-slate-500 hover:text-white text-sm transition group">
                        <span class="p-1 bg-slate-900 rounded group-hover:bg-emerald-500/20 transition"><svg
                                class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M11.944 0C5.346 0 0 5.346 0 11.944s5.346 11.944 11.944 11.944 11.944-5.346 11.944-11.944S18.542 0 11.944 0zm5.206 8.19l-1.78 8.385c-.134.6-.49.746-.994.464l-2.712-2.002-1.308 1.258c-.144.144-.265.265-.544.265l.195-2.766 5.035-4.547c.218-.195-.048-.304-.338-.11l-6.224 3.92-2.68-.838c-.58-.182-.593-.58.122-.857l10.475-4.037c.484-.182.908.108.76.81z" />
                            </svg></span> Telegram
                    </a>
                    <a href="https://x.com/0xlenador" target="_blank" rel="noopener"
                        class="flex items-center gap-2 text-slate-500 hover:text-white text-sm transition group">
                        <span class="p-1 bg-slate-900 rounded group-hover:bg-emerald-500/20 transition"><svg
                                class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://discord.gg/6QaVvzrn" target="_blank" rel="noopener"
                        class="flex items-center gap-2 text-slate-500 hover:text-white text-sm transition group">
                        <span class="p-1 bg-slate-900 rounded group-hover:bg-emerald-500/20 transition"><svg
                                class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://www.facebook.com/0xlenador/" target="_blank" rel="noopener"
                        class="flex items-center gap-2 text-slate-500 hover:text-white text-sm transition group">
                        <span class="p-1 bg-slate-900 rounded group-hover:bg-emerald-500/20 transition"><svg
                                class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="pt-8 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-slate-600 text-[10px] uppercase tracking-widest font-mono">
                    &copy; 2026 0x Leñador • Build in public
                </p>
                <div class="flex gap-6">
                    <span class="text-[10px] text-slate-700 font-mono uppercase tracking-tighter">Status: System
                        Operational</span>
