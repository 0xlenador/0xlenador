        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <a href="https://www.youtube.com/@0xlenadorgamefi" target="_blank" rel="noopener" class="flex items-center gap-2 text-slate-500 hover:text-white text-sm transition group">
                    ...
                    <a href="https://t.me/zero0xlenador" target="_blank" rel="noopener" class="flex items-center gap-2 text-slate-500 hover:text-white text-sm transition group">
                    ...
                    <a href="https://x.com/0xlenador" target="_blank" rel="noopener" class="flex items-center gap-2 text-slate-500 hover:text-white text-sm transition group">
